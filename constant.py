...
URI_DEL_POOL = '/smf_api/pools/{}?accesspath={}'
URI_GET_POOL_DETAIL = '/smf_api/pools/detail?accesspath={}'
...
SMF_KEY_MODE = 'mode'
SMF_KEY_REPLICATION_MODE = 'replicationMode'
SMF_KEY_FORCE = 'force'
...
SMF_KEY_POOL_ID = 'poolID'
SMF_KEY_POOLS = 'pools'
SMF_KEY_STORAGE_VOLUMES = 'storagVolumes'
...
MSG_REMOTE_MIRROR_SET_EXIST = ' remote mirror set exists'
MSG_DELETING_POOL = ' There are extents waiting to be cleared in the raid group'
